  ...
  Future _registerUser() async {
        ...
        body: json.encode(
          {
            ...
            "fcmToken":
                User.userFcmToken != null ? User.userFcmToken : "fcmToken",
          },
        ),
        headers: {
    ...
    if (json.decode(response.body)['statusCode'] == 200) {
      ...
      popDialog(
          ...
          context: context,
          content:
              'User with email ID ${json.decode(response.body)['payload']['err']['keyValue']['userID']} already exists. Please login in!',
          onPress: () {
            Navigator.push(
              context,
              PageTransition(
